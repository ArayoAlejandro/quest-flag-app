  ...
  return (
    <section className='game__options'>
      ...
      <div className='game__options__regions'>
        <Link to="/game" className='game__options__regions__button' onClick={() => { handleStart({ region: Region.europe }) }}>
          <span className='game__options__regions__span'>🌍</span>
          <p className='game__options__regions__paragraph'>EUROPE</p>
        </Link>
        <Link to="/game" className='game__options__regions__button' onClick={() => { handleStart({ region: Region.africa }) }}>
          <span className='game__options__regions__span'>🌍</span>
          <p className='game__options__regions__paragraph'>AFRICA</p>
        </Link>
        <Link to="/game" className='game__options__regions__button' onClick={() => { handleStart({ region: Region.asia }) }}>
          <span className='game__options__regions__span'>🌏</span>
          <p className='game__options__regions__paragraph'>ASIAN</p>
        </Link>
        <Link to="/game" className='game__options__regions__button' onClick={() => { handleStart({ region: Region.oceania }) }}>
          <span className='game__options__regions__span'>🌏</span>
          <p className='game__options__regions__paragraph'>OCEANIA</p>
        </Link>
        <Link to="/game" className='game__options__regions__button' onClick={() => { handleStart({ region: Region.america }) }}>
          <span className='game__options__regions__span'>🌎</span>
